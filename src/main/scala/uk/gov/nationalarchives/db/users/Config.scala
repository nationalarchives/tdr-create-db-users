...
object Config {
  case class LambdaConfig(driver: String, username: String, password: String, url: String, consignmentApiUser: String, migrationsUser: String, functionName: String)
  ...
  val kmsUtils: KMSUtils = KMSUtils(kms, Map("LambdaFunctionName" -> lambdaConfig.functionName))
